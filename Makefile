...
migrateup:
	migrate -path db/migration -database "postgresql://postgres:ZfB1KUUyt3mzRckpl7Oy@simple-bank.chaou48wi5ty.ap-south-1.rds.amazonaws.com:5432/simple_bank" -verbose up
migrateup1:
